...
<html>
  <head>
    <title>mnjs</title>
    <!--<script src="https://cdn.jsdelivr.net/npm/mnjs@3.1.1/browser/index.js"></script>-->
    <script src="https://cdn.jsdelivr.net/npm/mnjs/browser/index.js"></script>
...
// The change and change.equal functions are the same
// mnjs.change(x=1, y=1, z=0)
mnjs.change(1, 1, 0) === mnjs.change.equal(1, 1, 0)           // returns true
...
// The change.notequal function replace x (number or numeric array element) with z if x is not equal to y
// mnjs.change.notequal(x=1, y=1, z=0)
mnjs.change.equal(1, 1, 0) !== mnjs.change.notequal(1, 1, 0)  // returns true
mnjs.change.notequal(1, 1, 0)   //  returns 1
mnjs.change.notequal(1, NaN, 0) //  returns 0
mnjs.change.notequal(Infinity, Infinity, 0)            //  returns Infinity
mnjs.change.notequal([0, NaN, 1, Infinity], NaN, 0)      //  returns [0, 0, 0, 0]
// where [0 = new value, 0 = new value, 0 = new value, 0 = new value], all elements changed with new values!
mnjs.change.notequal([0, NaN, 1, Infinity], Infinity, 0) //  returns [0, 0, 0, Infinity]
...
| change.equal    | The change.equal function replace x (number or numeric array element) with z if x = y | function: change.equal(x, y, z)                              |
| change.notequal | The change.notequal replace x (number or numeric array element) with z if x is not equal to y | function: change.notequal(x, y, z)                           |
